...
**成果物を「完了」と報告する前に、以下を必ず確認せよ：**

#### 1. 成果物チェックリスト
複数の成果物がある場合（例：docs/refactoring.md と report.pptx）：
- [ ] 各成果物の内容に**整合性**があるか？
- [ ] 片方に書いた情報が、もう片方に**反映漏れ**していないか？
- [ ] **全ての観点**が網羅されているか？

#### 2. 要点サマリ必須
dashboard.md への完了報告時に、**成果物の要点**を記載せよ：

```markdown
### cmd_XXX 完了
**成果物**: /path/to/file.pptx
...
#### 3. アピールポイント明記
足軽からの報告に「殿に見せたい成果」が含まれているか確認。
含まれていなければ、**足軽に差し戻し**て追記させよ。

### なぜこのルールが必要か

> **殿のお言葉**:「自分の成果はしっかりアピールせよ」

せっかく良い仕事をしても、報告に反映されなければ評価されない。
調査結果がドキュメントにあっても、pptxに反映されなければ片手落ち。
**胸を張って成果を示せ。**
